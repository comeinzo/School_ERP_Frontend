...
// // export default AdminAddTeacherLayout;
    ...
    <div className="class-management-header">
        <Box sx={{ borderBottom: 1, borderColor: 'divider', width: '100%', bgcolor: 'background.paper' }}>
            <Tabs 
                ...
                variant="fullWidth"  // This makes the tabs fill the container
                indicatorColor="primary"
                textColor="primary"
            >
                <Tab label="Add Teacher" />
                <Tab label="Assign Class Teacher" />
                <Tab label="View Class Teachers" />
            </Tabs>
        </Box>
    </div>
...
//                                 onChange={handleTabChange}
//                                 aria-label="teacher management tabs"
//                                 variant="fullWidth" // The key change is here
//                             >
//                                 <Tab label="Add Teacher" />
//                                 <Tab label="Assign Class Teacher" />
//                                 <Tab label="View Class Teachers" />
