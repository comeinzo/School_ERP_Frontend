...
// //               </Grid>
// //               {/* <Grid item xs={12} sm={6}>
// //                 <FormControl fullWidth required error={!!errors.gender} className="stylish-radio-group">
...
//     margin: 'auto', 
//     p: { xs: 1, md: 1 }, // Added responsive padding from your original code
//     // backgroundColor: '#0e2343ff' // Soft and professional off-white
//   }}
// >
//         {/* Admission Details Card */}
//         {/* <Card sx={{ mb: 3 ,
//           backgroundColor: '#192e42ff'
//         }}>
//           <CardContent>
//             <Typography variant="h5" gutterBottom>📋 Admission Details</Typography>
//             <Grid container spacing={3}>
...
//         {/* Previous School & Other Details Card */}
//         <Card sx={{ mb: 3 ,backgroundColor: '#e9edf1ff'}}>
//           <CardContent>
//             <Typography variant="h5" gutterBottom>🏫 Previous School & Other Details</Typography>
//             <Grid container spacing={3}>
